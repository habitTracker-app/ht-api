        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChallengeCategoryId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Challenge", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Challenge_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Challenge_ChallengeCategory_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "ChallengeCategory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Challenge_ChallengeCategory_ChallengeCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Friendship_AspNetUsers_TargetId",
                        column: x => x.TargetId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ChallengesId = table.Column<Guid>(type: "uuid", nullable: false),
                    ParticipantsId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChallengeUser", x => new { x.ChallengesId, x.ParticipantsId });
                    table.ForeignKey(
                        name: "FK_ChallengeUser_AspNetUsers_ParticipantsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Goal_Challenge_ChallengeId",
                        column: x => x.ChallengeId,
                        principalTable: "Challenge",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Goal_Frequency_FrequencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedProgressPercentage = table.Column<int>(type: "integer", nullable: false),
                    ProgressMeasure = table.Column<float>(type: "real", nullable: false),
                    GoalComplete = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Challenge_ChallengeCategoryId",
                table: "Challenge",
                column: "ChallengeCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Challenge_OwnerId",
                table: "Challenge",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ChallengeCategory_Description",
                table: "ChallengeCategory",
                column: "Description",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChallengeCategory_Name",
                table: "ChallengeCategory",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChallengeUser_ParticipantsId",
                table: "ChallengeUser",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Goal_ChallengeId",
                table: "Goal",
                column: "ChallengeId");

            migrationBuilder.CreateIndex(
                name: "IX_Goal_FrequencyId",
                table: "Goal",
                column: "FrequencyId");
